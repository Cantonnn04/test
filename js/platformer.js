...
{
  platforms:[[0,344,643,16],[0,241,219,16],[58,91,153,16],[112,0,99,63],[277,158,141,15],{x:192,y:124,w:104,h:16,angle:0.74369},[434,63,120,16],[514,330,102,14]],
  moving:[{x:434,y:193,w:80,h:14,x0:null,x1:null,y0:124,y1:347,speed:1.5}],
  walls:[{x:418,y:0,w:16,h:344},{x:538,y:79,w:16,h:215}],
  spikes:[{x:60,y:82,w:25,h:8},{x:557,y:0,w:83,h:12,angle:3.11744}],
  ladders:[{x:240,y:240,w:28,h:106,angle:2.70166}],
  springs:[{x:24,y:225,w:24,h:16}],
  turrets:[{x:554,y:106,w:24,h:24,angle:0,interval:1.5},{x:616,y:320,w:24,h:24,angle:-1.56777,interval:2}],
  portals:[{index:0,color:'#00ff44',surface:'floor',x:370,y:130,w:14,h:28},{index:1,color:'#ff6600',surface:'floor',x:459,y:35,w:14,h:28}],
  goal:{x:459,y:88,w:18,h:18},
  playerStart:{x:0,y:316},
  bg:'#0a0a1a', pc:'#4444ff'
},
{
  platforms:[[70,296,663,8],[275,65,318,16],[504,201,139,8],[70,238,161,16],[69,154,111,16],[-33,355,674,8],[151,97,80,8],[0,0,231,8]],
  moving:[{x:291,y:170,w:80,h:14,x0:292,x1:639,y0:null,y1:null,speed:1.5},{x:469,y:254,w:80,h:14,x0:291,x1:639,y0:null,y1:null,speed:1.5}],
  walls:[{x:275,y:81,w:16,h:215},{x:231,y:0,w:16,h:254},{x:54,y:154,w:16,h:150},{x:95,y:74,w:15,h:80}],
  spikes:[{x:294,y:284,w:349,h:12},{x:504,y:189,w:136,h:12},{x:96,y:62,w:14,h:12},{x:55,y:142,w:40,h:12},{x:-171,y:168,w:354,h:16,angle:1.565},{x:277,y:347,w:8,h:8}],
  ladders:[{x:247,y:65,w:28,h:231}],
  springs:[{x:192,y:222,w:24,h:16}],
  turrets:[{x:347,y:81,w:24,h:24,angle:1.57541,interval:1.5},{x:449,y:81,w:24,h:24,angle:1.56434,interval:1.3},{x:560,y:81,w:24,h:24,angle:1.56879,interval:1.7}],
  portals:[{index:0,color:'#00ff44',surface:'floor',x:615,y:226,w:14,h:28},{index:1,color:'#ff6600',surface:'floor',x:81,y:209,w:14,h:28}],
  goal:{x:604,y:319,w:18,h:18},
  playerStart:{x:70,y:268},
  bg:'#0a0a1a', pc:'#4444ff'
},
];
